...
namespace AutoBuild
{
	...
	//-------------------------------------------------------------------------------------------------
	bool InstallServiceAction::LoadConfiguration(const boost::property_tree::ptree& actionConfig, ExceptionReporter reportException, ExceptionReporter reportInvalidProperty)
	{
		return true;
	}
